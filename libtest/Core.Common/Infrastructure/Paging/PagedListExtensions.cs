...
namespace Core.Common.Infrastructure.Paging
{
    /// <summary>
    ...
    public static class PagedListExtensions
    {
        ...
        {
            return ToPagedList<T>(superset.ToList());
        }

        public static IPagedList<T> ToPagedList<T>(this IQueryable<T> superset, int pageNumber, int pageSize, int totalItemCount)
        {
            return new PagedList<T>(superset, pageNumber, pageSize, totalItemCount);
        }
