...
namespace Utilities.PagedList
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="StaticPagedList{T}" /> class that contains the already divided subset
        ///     and information about the size of the superset and the subset's position within it.
        /// </summary>
        /// <param name="subset">The single subset this collection should represent.</param>
        /// <param name="metaData">
        ///     Supply the ".MetaData" property of an existing IPagedList instance to recreate it here (such as
        ///     when creating a new instance of a PagedList after having used Automapper to convert its contents to a DTO.)
        /// </param>
