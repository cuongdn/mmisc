...
{
    public static class ModelPortal
    {
        ...
        public static IList<T> FetchChildren<T>(IEnumerable list, params object[] parameters)
            where T : ModelBase, new()
        {
            var result = new List<T>();
            foreach (var item in list)
            {
                result.Add(FetchChild<T>(item, parameters));
            }
            return result;
        }
        ...
        public static T FetchChild<T>(object item, params object[] parameters)
            where T : new()
        {
