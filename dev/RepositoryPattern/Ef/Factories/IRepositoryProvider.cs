...
namespace RepositoryPattern.Ef.Factories
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    ///     Repositories created by this provider tend to require a <see cref="Ef.DataContext" />
    ///     to retrieve data.
    /// </remarks>
    public interface IRepositoryProvider
    {
        ...
        /// </typeparam>
        /// <param name="factory">
        ///     An optional repository creation function that takes a <see cref="Ef.DataContext" />
