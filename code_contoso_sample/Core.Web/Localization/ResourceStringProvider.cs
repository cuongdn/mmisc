...
namespace Core.Web.Localization
{
    ...
    public class ResourceStringProvider : ILocalizedStringProvider
    {
        ...
        public ResourceStringProvider(Assembly assembly, Func<Type, bool> predicate = null)
        {
            ...
            var resourceManagers = types.Select(type => new ResourceManager(type)).ToList();
            _resourceManagers.AddRange(resourceManagers);
        }
